...
export const VEHICLES = {
  ...
  pz3j: {
    ...
    model: {
      hull: { len: 5.5, wid: 2.4, hgt: 1.10, clear: 0.42 }, glacis: { len: 1.1, slope: 21 },
      tracks: { wid: 0.4, hgt: 0.78, wheels: 6, wheelR: 0.33, rollers: 3, style: 'torsion' },
      turret: { len: 2.3, wid: 1.9, hgt: 0.90, z: 0.15, shape: 'box', slope: 15, cupola: true },
  ...
  pz4h: {
    ...
    model: {
      hull: { len: 5.9, wid: 2.9, hgt: 1.12, clear: 0.4 }, glacis: { len: 0.9, slope: 12 },
      tracks: { wid: 0.4, hgt: 0.8, wheels: 8, wheelR: 0.235, rollers: 4, style: 'bogie' },
      turret: { len: 2.6, wid: 2.1, hgt: 0.95, z: 0.1, shape: 'box', slope: 10, cupola: true },
  ...
  stug3g: {
    ...
    model: {
      hull: { len: 5.6, wid: 2.95, hgt: 0.95, clear: 0.4 }, glacis: { len: 1.2, slope: 21 },
      tracks: { wid: 0.4, hgt: 0.78, wheels: 6, wheelR: 0.33, rollers: 3, style: 'torsion' },
      casemate: { len: 3.4, wid: 2.7, hgt: 0.82, slope: 9 },
  ...
  panther_a: {
    ...
    model: {
      hull: { len: 6.9, wid: 3.3, hgt: 1.14, clear: 0.55 }, glacis: { len: 1.9, slope: 55 },
      tracks: { wid: 0.66, hgt: 0.95, wheels: 8, wheelR: 0.43, rollers: 0, style: 'interleaved' },
      turret: { len: 3.0, wid: 2.3, hgt: 0.95, z: 0.35, shape: 'hex', slope: 12, cupola: true },
  ...
  tiger1: {
    ...
    model: {
      hull: { len: 6.3, wid: 3.55, hgt: 1.28, clear: 0.47 }, glacis: { len: 1.0, slope: 10 },
      tracks: { wid: 0.72, hgt: 0.98, wheels: 8, wheelR: 0.4, rollers: 0, style: 'interleaved' },
      turret: { len: 3.4, wid: 2.5, hgt: 0.98, z: 0.15, shape: 'round', slope: 4, cupola: true },
  ...
  sdkfz251: {
    ...
    model: {
      hull: { len: 5.8, wid: 2.1, hgt: 1.00, clear: 0.35 }, glacis: { len: 0.6, slope: 25 },
  ...
  t34_76: {
    ...
    model: {
      hull: { len: 6.1, wid: 3.0, hgt: 1.18, clear: 0.4 }, glacis: { len: 1.8, slope: 60 },
      tracks: { wid: 0.55, hgt: 0.85, wheels: 5, wheelR: 0.42, rollers: 0, style: 'christie' },
      turret: { len: 2.2, wid: 2.0, hgt: 0.72, z: 0.0, shape: 'hex', slope: 30, cupola: false },
  ...
  t34_85: {
    ...
    model: {
      hull: { len: 6.1, wid: 3.0, hgt: 1.18, clear: 0.4 }, glacis: { len: 1.8, slope: 60 },
      tracks: { wid: 0.55, hgt: 0.85, wheels: 5, wheelR: 0.42, rollers: 0, style: 'christie' },
      turret: { len: 2.7, wid: 2.35, hgt: 0.92, z: 0.05, shape: 'round', slope: 18, cupola: true },
  ...
  su85: {
    ...
    model: {
      hull: { len: 6.1, wid: 3.0, hgt: 1.00, clear: 0.4 }, glacis: { len: 1.6, slope: 50 },
      tracks: { wid: 0.55, hgt: 0.85, wheels: 5, wheelR: 0.42, rollers: 0, style: 'christie' },
      casemate: { len: 3.6, wid: 2.8, hgt: 1.00, slope: 50 },
      gun: { len: 4.15, r: 0.062, brake: false, mantlet: 'round' },
  ...
  kv1: {
    ...
    model: {
      hull: { len: 6.75, wid: 3.3, hgt: 1.17, clear: 0.43 }, glacis: { len: 1.2, slope: 30 },
      tracks: { wid: 0.7, hgt: 0.9, wheels: 6, wheelR: 0.32, rollers: 3, style: 'torsion' },
      turret: { len: 3.0, wid: 2.4, hgt: 0.90, z: 0.0, shape: 'round', slope: 10, cupola: true },
      gun: { len: 3.16, r: 0.058, brake: false, mantlet: 'round' },
  ...
  is2: {
    ...
    model: {
      hull: { len: 6.77, wid: 3.07, hgt: 1.05, clear: 0.47 }, glacis: { len: 1.7, slope: 60 },
      tracks: { wid: 0.65, hgt: 0.92, wheels: 6, wheelR: 0.36, rollers: 3, style: 'torsion' },
      turret: { len: 3.2, wid: 2.5, hgt: 0.98, z: 0.1, shape: 'round', slope: 20, cupola: true },
  ...
  m4a1: {
    ...
    model: {
      hull: { len: 5.84, wid: 2.62, hgt: 1.20, clear: 0.43 }, glacis: { len: 1.4, slope: 56 },
      tracks: { wid: 0.42, hgt: 0.75, wheels: 6, wheelR: 0.25, rollers: 3, style: 'vvss' },
      turret: { len: 2.4, wid: 2.1, hgt: 0.85, z: 0.15, shape: 'cast', slope: 12, cupola: true },
  ...
  m4a3e8: {
    ...
    model: {
      hull: { len: 6.27, wid: 3.0, hgt: 1.18, clear: 0.43 }, glacis: { len: 1.5, slope: 47 },
      tracks: { wid: 0.58, hgt: 0.78, wheels: 6, wheelR: 0.28, rollers: 3, style: 'hvss' },
      turret: { len: 2.9, wid: 2.2, hgt: 0.88, z: 0.15, shape: 'cast', slope: 12, cupola: true },
  ...
  m10: {
    ...
    model: {
      hull: { len: 5.97, wid: 3.05, hgt: 1.02, clear: 0.43 }, glacis: { len: 1.5, slope: 55 },
      tracks: { wid: 0.42, hgt: 0.75, wheels: 6, wheelR: 0.25, rollers: 3, style: 'vvss' },
      turret: { len: 2.6, wid: 2.1, hgt: 0.88, z: 0.3, shape: 'wedge', slope: 45, openTop: true },
  ...
  m3halftrack: {
    ...
    model: {
      hull: { len: 6.14, wid: 2.2, hgt: 1.10, clear: 0.35 }, glacis: { len: 0.5, slope: 25 },
...
export function componentLayout(v) {
  ...
  const parts = [
    ...
    // Fuel sits in the rear sponson beside the engine, not inside it, which is
    // why a hit low on the side so often sets a tank alight.
    { id: 'fuel',         x: -w * 0.6, y: floor + h.hgt * 0.3,  z: -half * 0.5,  r: 0.50, hp: 70,  volatile: 0.18 },
